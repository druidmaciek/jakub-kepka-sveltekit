...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-46c5a7b5.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-46c5a7b5.js", "/./_app/chunks/vendor-7708653e.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = {"src/routes/__layout.svelte": {entry: "/./_app/pages/__layout.svelte-7dca6555.js", css: ["/./_app/assets/pages/__layout.svelte-9623c3d7.css"], js: ["/./_app/pages/__layout.svelte-7dca6555.js", "/./_app/chunks/vendor-7708653e.js"], styles: null}, ".svelte-kit/build/components/error.svelte": {entry: "/./_app/error.svelte-48f0cf45.js", css: [], js: ["/./_app/error.svelte-48f0cf45.js", "/./_app/chunks/vendor-7708653e.js"], styles: null}, "src/routes/index.svelte": {entry: "/./_app/pages/index.svelte-c0867b3a.js", css: ["/./_app/assets/pages/index.svelte-40e6ea07.css"], js: ["/./_app/pages/index.svelte-c0867b3a.js", "/./_app/chunks/vendor-7708653e.js"], styles: null}};
...
var Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="${"nav"}" class="${"mt-24 p-1 sm:py-2 sm:px-4 flex justify-between items-center text-gray-50 uppercase text-xs  sm:text-base"}"><a href="${"#hero"}">\xA9 ${escape3(year)} Jakub K\u0119pka</a>
    ...
    <div class="${"hidden sm:block flex justify-start space-x-8 font-semibold"}"><a href="${"#about"}">About</a>
        <a href="${"#photos"}">Photoshoots</a>
        <a href="${"#nav"}">Paintings</a></div>

    <div><a href="${"https://janowski.dev"}">Made by: Janowski.dev</a></div></div>`;
});
...
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="${"nav"}" class="${"px-2 sm:px-0 flex justify-between items-center text-gray-50 uppercase"}"><span class="${"text-4xl cursor-default font-black tracking-tight font-title"}">Jakub K\u0119pka</span>
    ...
    <div class="${"flex justify-start items-center space-x-2 font-semibold"}"><a class="${"p-1 hidden sm:block"}" href="${"#about"}">${escape3($_("nav.about"))}</a>
        <a class="${"p-1 hidden sm:block"}" href="${"#nav"}">Paintings</a>
        <a class="${"p-1 hidden sm:block"}" href="${"#photos"}">Photoshoots</a>
        <a class="${"p-1 hidden sm:block"}" href="${"#contact"}">Contact</a>

        <button class="${"block sm:hidden p-1 bg-gray-50 hover:bg-gray-300 rounded"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" class="${"text-gray-900 h-5 w-5"}" fill="${"none"}" viewBox="${"0 0 24 24"}" stroke="${"currentColor"}"><path stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" d="${"M4 6h16M4 12h16M4 18h16"}"></path></svg></button></div></div>
  ...
  return `<div class="${"fixed z-50 inset-0 overflow-y-auto"}"><div class="${"flex items-end justify-center min-h-screen px-4 pb-20 text-center sm:block sm:p-0"}"><div class="${"fixed inset-0 transition-opacity"}"><div class="${"absolute inset-0 bg-black"}"></div></div>
        ...
        <div class="${"inline-block align-bottom bg-black px-4 text-left overflow-hidden\n          transform transition-all sm:mt-4 sm:align-middle sm:max-w-4xl sm:w-full sm:px-6"}" role="${"dialog"}" aria-modal="${"true"}" aria-labelledby="${"modal-headline"}">
            <div class="${"flex justify-between items-center"}"><button class="${"inline-flex focus:outline-none"}"><svg class="${"h-6 w-6 text-gray-50"}" xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"0 0 20 20"}" fill="${"currentColor"}"><path fill-rule="${"evenodd"}" d="${"M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z"}" clip-rule="${"evenodd"}"></path></svg>
                    <span x-show="${"eng"}" class="${"ml-2 font-semibold uppercase text-gray-50"}">Back</span></button>
            ...
            <div class="${"mt-4"}"><img style="${"max-height: 500px;"}" width="${"640"}" height="${"360"}" class="${"w-full object-contain"}"${add_attribute("src", painting.content.image.filename, 0)} alt="${""}">
                <div class="${"text-gray-50 text-cente mt-6"}"><h2 class="${"text-4xl  font-title font-black mb-2"}">${escape3(painting.content.Title_ENG)}</h2>
                    <p>${md.render(painting.content.Description_ENG)}</p></div></div></div></div></div>`;
});
var Grid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${``}
<div class="${"mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10"}">${each(paintings, (painting, i) => `${i < 6 ? `${validate_component(Painting, "Painting").$$render($$result, {painting}, {}, {})}` : `${!preview ? `${validate_component(Painting, "Painting").$$render($$result, {painting}, {}, {})}` : ``}`}`)}</div>
...
var About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div id="${"about"}" class="${"mt-24 mb-24 text-gray-50 max-w-2xl mx-auto"}"><div class="${""}"><h1 class="${"uppercase text-3xl font-black tracking-tight"}">Jakub K\u0119pka</h1>
		<p class="${"mt-4 tracking-wider leading-loose"}">Young artist from Warsaw. Student of International School of Clothing Design and Costume
			Design. A painter by avocation. Possesses works in galleries &quot;House with Art&quot; Pragaleria&quot;,
			&quot;Avantgarden&quot;, &quot;Xanadu Gallery&quot;, some works also on Gallerystore.pl, and took part in this
			year&#39;s Fair of Accessible Art, I also cooperate with Artinfo and Onebid.pl in which he
			exhibited, among others, works for charity. He gave an interview to the National Centre of
			Culture, which is available on YouTube.
		</p>
		<p class="${"mt-2 tracking-wider leading-loose"}">The artist tries to focus on emotions, pouring the feelings he cannot cope with onto canvas.
			Each work, whether painting or fashion, deals with personal problems, and heavy emotions or
			traumas. The artist has a collection entitled &quot;All These Emotions&quot;, &quot;Deed and Punishment&quot; and
			&quot;Plasticity of Form&quot;. The collections successively tell about personal feelings. The series
			are not closed, as they are created together with the feelings and course of the artist&#39;s
			life. In connection with designing clothes, the artist creates photo sessions. Each fashion
			shoot is a personal vision. The general idea, the background, the scenario and all the clothes
			are sewn, constructed, stylized by the author. With the help of other artists or models I
			manage to translate my thoughts, in this case into fashion, as in painting. It is also
			important to note that each of the silhouettes is created with materials from second-hand
			shops.
		</p>
		<p class="${"mt-2 tracking-wider text-cente leading-loose"}">With the help of other artists or models I manage to translate my thoughts, in this case into
			fashion, as in painting. It is also important to note that each of the silhouettes is created
			with materials from second-hand shops.
		</p></div></div>`;
});
var Photoshoot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.left === void 0 && $$bindings.left && left !== void 0)
    $$bindings.left(left);
  return `<div class="${"sm:flex sm:items-start mt-24 sm:mt-48 px-4 sm:px-0"}"><div class="${escape3(left ? "order-1" : "order-2") + " w-full sm:w-3/5 pl-0 sm:px-12 text-gray-50 text-center sm:text-left"}"><h2 class="${"mt-4 text-5xl smtext-3xl uppercase font-semibold font-title tracking-wider cursor-pointer"}">${escape3(photoshoot.content.name_eng)}</h2>
      <div class="${"hidden sm:block mt-2 prose font-normal"}">${md.render(photoshoot.content.desc_eng)}</div>
      <button class="${"mb-6 sm:mb-0 mt-6 text-xl font-semibold tracking-wider hover:underline"}">See Session
      </button></div>
...
create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"fixed z-50 inset-0 overflow-y-auto"}"><div class="${"flex items-end justify-center min-h-screen px-4 pb-20 text-center sm:block sm:p-0"}"><div class="${"fixed inset-0 transition-opacity"}"><div class="${"absolute inset-0 bg-black"}"></div></div>
        ...
        <div class="${"inline-block align-bottom bg-black px-4 text-left overflow-hidden\n          transform transition-all sm:mt-4 sm:align-middle sm:max-w-4xl sm:w-full sm:px-6"}" role="${"dialog"}" aria-modal="${"true"}" aria-labelledby="${"modal-headline"}">
            <div class="${"flex justify-between items-center"}"><button class="${"inline-flex focus:outline-none"}"><svg class="${"h-6 w-6 text-gray-50"}" xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"0 0 20 20"}" fill="${"currentColor"}"><path fill-rule="${"evenodd"}" d="${"M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z"}" clip-rule="${"evenodd"}"></path></svg>
                    <span class="${"ml-2 font-semibold uppercase text-gray-50"}">Back</span></button>
                <button class="${"focus:outline-none"}"><svg class="${"h-6 w-6 text-gray-50"}" xmlns="${"http://www.w3.org/2000/svg"}" fill="${"none"}" viewBox="${"0 0 24 24"}" stroke="${"currentColor"}"><path stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" d="${"M6 18L18 6M6 6l12 12"}"></path></svg></button></div>

            
            <div class="${"mt-4"}"><div class="${"block overflow-x-auto flex items-center justify-between"}">${each(gallery, (image) => `<img style="${"max-height: 500px;"}" width="${"640"}" height="${"360"}" class="${"w-full object-contain"}"${add_attribute("src", image.filename.replace("//a.storyblok.com", "//img2.storyblok.com/500x0/filters:quality(90),format(png)"), 0)} alt="${""}">`)}</div>
                <div class="${"hidden"}"><button type="${"button"}"><svg class="${"text-white hover:text-gray-500 h-6 w-6"}" xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"0 0 20 20"}" fill="${"currentColor"}"><path fill-rule="${"evenodd"}" d="${"M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z"}" clip-rule="${"evenodd"}"></path></svg></button>
                    <img style="${"max-height: 500px;"}" width="${"640"}" height="${"360"}" class="${"w-full object-contain"}"${add_attribute("src", gallery[activeImage].filename.replace("//a.storyblok.com", "//img2.storyblok.com/800x0/filters:quality(90),format(png)"), 0)} alt="${""}">
                    <button type="${"button"}"><svg class="${"text-white hover:text-gray-500 h-6 w-6"}" xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"0 0 20 20"}" fill="${"currentColor"}"><path fill-rule="${"evenodd"}" d="${"M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z"}" clip-rule="${"evenodd"}"></path></svg></button></div>
                <div class="${"text-white mt-6"}"><h2 class="${"text-3xl font-bold mb-2"}">${escape3(photoshoot.content.name_eng)}</h2>
                    <div>${md.render(photoshoot.content.desc_eng)}</div></div></div></div></div></div>`;
});
...
<div id="${"photos"}" class="${"mt-48"}">${each(photoshoots, (photoshoot, i) => `${validate_component(Photoshoot, "Photoshoot").$$render($$result, {photoshoot, left: i % 2 == 0}, {}, {})}`)}</div>`;
});
var Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div id="${"contact"}" class="${"text-gray-50 mt-24 px-4"}"><div class="${"sm:text-center"}"><h2 class="${"text-5xl uppercase font-semibold font-title "}">Kontakt</h2>
...
<div class="${"max-w-7xl mx-auto sm:px-6 lg:px-8"}">${validate_component(Nav, "Nav").$$render($$result, {}, {}, {})}

    ${validate_component(Grid, "Grid").$$render($$result, {paintings}, {}, {})}


    ${validate_component(About, "About").$$render($$result, {}, {}, {})}

    ${validate_component(List, "List").$$render($$result, {photoshoots}, {}, {})}

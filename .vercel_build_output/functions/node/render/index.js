...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-1a91aa02.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-1a91aa02.js", "/./_app/chunks/vendor-d852fa6e.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = {"src/routes/__layout.svelte": {entry: "/./_app/pages/__layout.svelte-df6261c9.js", css: ["/./_app/assets/pages/__layout.svelte-57f41c9e.css"], js: ["/./_app/pages/__layout.svelte-df6261c9.js", "/./_app/chunks/vendor-d852fa6e.js"], styles: null}, ".svelte-kit/build/components/error.svelte": {entry: "/./_app/error.svelte-96ccf094.js", css: [], js: ["/./_app/error.svelte-96ccf094.js", "/./_app/chunks/vendor-d852fa6e.js"], styles: null}, "src/routes/index.svelte": {entry: "/./_app/pages/index.svelte-f4eb818e.js", css: ["/./_app/assets/pages/index.svelte-40e6ea07.css"], js: ["/./_app/pages/index.svelte-f4eb818e.js", "/./_app/chunks/vendor-d852fa6e.js"], styles: null}};
...
var Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="${"nav"}" class="${"py-2 px-4 flex justify-between items-center text-gray-50 uppercase"}"><a href="${"#hero"}">\xA9 ${escape3(year)} Jakub K\u0119pka</a>

    <div class="${"flex justify-start space-x-8 font-semibold"}"><a href="${"#about"}">About</a>
...
var Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="${"hero"}" class="${"relative mb-24 text-gray-50 font-title max-h-screen"}"><div class="${"h-screen relative"}" id="${"hero-image"}">${each(images, (image, i) => `<img style="${"opacity:0"}" class="${escape3(current === i ? "!opacity-25" : "opacity-0") + " opacity-0 absolute h-screen w-full object-cover object-top svelte-9w9yqb"}"${add_attribute("src", image, 0)} alt="${""}">`)}</div>
	<div class="${"absolute inset-0"}"><div class="${"flex justify-center"}"><div><h1 class="${"mt-64 uppercase text-9xl font-black tracking-tight"}">Jakub K\u0119pka</h1>
				<div class="${"mt-4 text-center"}"><a href="${"#nav"}" class="${"group outline-none"}"><p class="${"uppercase font-semibold text-3xl group-hover:text-gray-200"}">Skip</p>
...
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div id="${"nav"}" class="${"flex justify-between items-center text-gray-50 uppercase"}"><span class="${"text-4xl font-black tracking-tight font-title"}">Jakub K\u0119pka</span>
...
var Painting = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"group aspect-w-10 aspect-h-12 cursor-pointer"}"><img class="${"rounded-sm border border-gray-900 object-cover object-top sm:object-center lg:h-full lg:w-full group-hover:opacity-25"}"${add_attribute("src", painting.content.image.filename, 0)}${add_attribute("alt", painting.content.image.alt, 0)}>
        ...
        <div class="${"inline-block align-bottom bg-black px-4 text-left overflow-hidden\n          transform transition-all sm:mt-4 sm:align-middle sm:max-w-4xl sm:w-full sm:px-6"}" role="${"dialog"}" aria-modal="${"true"}" aria-labelledby="${"modal-headline"}">
            ...
            <div class="${"mt-4"}"><img style="${"max-height: 500px;"}" width="${"640"}" height="${"360"}" class="${"w-full object-contain"}"${add_attribute("src", painting.content.image.filename, 0)} alt="${""}">
                <div class="${"text-gray-50 text-cente mt-6"}"><h2 class="${"text-4xl  font-title font-black mb-2"}">${escape3(painting.content.Title_ENG)}</h2>
                    <p x-html="${"md.render(painting.content.Description_ENG)"}">${escape3(painting.content.Description_ENG)}</p></div></div></div></div></div>
...
<div class="${"hidden z-50 flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-black "}"><div class="${"mt-16 max-w-4xl mx-auto"}"><div class="${"flex justify-between items-center text-gray-50"}"><button>X</button>
            <button>X</button></div>
		<img width="${"640"}" height="${"360"}" class="${"w-full max-h-[600px] object-contain"}"${add_attribute("src", painting.content.image.filename, 0)}${add_attribute("alt", painting.content.image.alt, 0)}>
        <div class="${"text-gray-50 mt-6"}"><h2 class="${"text-3xl font-bold mb-2"}">${escape3(painting.content.Title_ENG)}</h2>
            <p x-html="${"md.render(painting.content.Description_ENG)"}">${escape3(painting.content.Description_ENG)}</p></div></div></div>`;
});
...
<div><div class="${"relative flex justify-center items-center"}"><button class="${"absolute z-40 mt-64 cursor-pointer group focus:outline-none"}"><div class="${"uppercase tracking-wider font-semibold  text-xl text-gray-50 group-hover:text-gray-200"}">${preview ? `<span>Show All</span>` : `<span>Hide</span>`}</div>
...
var About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div id="${"about"}" class="${"my-64 text-gray-50 max-w-2xl mx-auto"}"><div class="${""}"><h1 class="${"uppercase text-3xl font-black tracking-tight"}">Jakub K\u0119pka</h1>
...
async function load({page, fetch: fetch3, session, context}) {
  ...
  if (res.data.stories) {
    return {
      props: {paintings: await res.data.stories}
    };
  }
  return {
    status: res.status,
